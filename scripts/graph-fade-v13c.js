// v13c target-on/target-off with text proximity detection and corrected active styling
(function() {
    ...
    function init() {
        ...
        console.log('composite-chart found, text radius:', text_radius, 'px');
    ...
    function checkTextProximity(mouseX, mouseY) {
        ...
        if (hoveredLineGraph && hoveredLineGraph !== activeLineGraph) {
            ...
            console.log('Mouse near line-graph text:', hoveredLineGraph.id);
            ...
            console.log('Mouse away from line-graph text');
