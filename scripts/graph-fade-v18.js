...
(function() {
    ...
    function handleMouseMove(e) {
        ...
        // Get composite-chart bounds (NOT document bounds)
    ...
    function updateDebugVisual(e) {
        try {
            ...
            if (ctm) {
                ...
                console.log('Debug circle at SVG coords:', {
